...
int ButtonGameObject::setTextures(void (setFuncPtr)(GLuint w, const char* fname, int skipX, int skipY, int rowHeight, int colLength), GLuint* textures, int offset) {
    int rowHeight = 85;
    int colWidth = 370;

    setFuncPtr(textures[offset + 0], "Assets\\gui\\start-button.png", 0, 0, colWidth, rowHeight);
    setFuncPtr(textures[offset + 1], "Assets\\gui\\start-button.png", 0, rowHeight, colWidth, rowHeight);
    startButtonTextureID = textures[offset + 0];
    startButtonActiveTextureID = textures[offset + 1];

    setFuncPtr(textures[offset + 2], "Assets\\gui\\quit-button.png", 0, 0, colWidth, rowHeight);
    setFuncPtr(textures[offset + 3], "Assets\\gui\\quit-button.png", 0, rowHeight, colWidth, rowHeight);
    ...
    setFuncPtr(textures[offset + 4], "Assets\\gui\\resume-button.png", 0, 0, colWidth, rowHeight);
    setFuncPtr(textures[offset + 5], "Assets\\gui\\resume-button.png", 0, rowHeight, colWidth, rowHeight);
    resumeButtonTextureID = textures[offset + 4];
    resumeButtonActiveTextureID = textures[offset + 5];

    setFuncPtr(textures[offset + 6], "Assets\\gui\\abandon-button.png", 0, 0, colWidth, rowHeight);
    setFuncPtr(textures[offset + 7], "Assets\\gui\\abandon-button.png", 0, rowHeight, colWidth, rowHeight);
